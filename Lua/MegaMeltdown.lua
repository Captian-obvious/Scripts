...
function finale()
    ...
    msg:MakeSystemMessage("all", {Text = [[[Ending]: Reactor exploded, thanks for playing!]], Color = Color3.new(1,0,0), })
end
...
task.wait(15)
ann2:Play()
msg:MakeSystemMessage("all", {Text = [[[Warning]: Core Overheating, Nuclear Meltdown Imminent.]], Color = Color3.new(1,0,0), })
task.wait(15)
ann2:Play()
msg:MakeSystemMessage("all", {Text = [[[Warning]: Core Overheating, Nuclear Meltdown Imminent.]], Color = Color3.new(1,0,0), })
task.wait(15)
evac:Play()
msg:MakeSystemMessage("all", {Text = [[[Warning]: Please prepare for emergency evacuation.]], Color = Color3.new(1,0,0), })
alarm:Play()
task.wait(10)
alarm:Stop()
task.wait(15)
ann3:Play()
msg:MakeSystemMessage("all", {Text = [[[Warning]: Reactor Core is at critical temp^@%*]], Color = Color3.new(1,0,0), })
task.wait(15)
ann4:Play()
msg:MakeSystemMessage("all", {Text = [[[Warning]: All Reactor Core Safeguards are now nonfunctional, Please prepare for reactor core meltdown.]], Color = Color3.new(1,0,0), })
task.wait(5)
msg:MakeSystemMessage("all", {Text = [[{MELTDOWN IMMINENT}]], Color = Color3.new(1,0,0), })
task.wait(2)
evac:Play()
msg:MakeSystemMessage("all", {Text = [[[Warning]: Please prepare for emergency evacuation.]], Color = Color3.new(1,0,0), })
alarm:Play()
...
task.wait(5)
ann5:Play()
msg:MakeSystemMessage("all", {Text = [[[Warning]: Reactor Explosion in 4 Minutes.]], Color = Color3.new(1,0,0), })
task.wait(5)
evac:Play()
msg:MakeSystemMessage("all", {Text = [[[Warning]: Please prepare for emergency evacuation.]], Color = Color3.new(1,0,0), })
task.wait(5)
...
task.wait(38)
ann6:Play()
msg:MakeSystemMessage("all", {Text = [[[Warning]: Reactor Explosion timer !DESTROYED!]], Color = Color3.new(1,0,0), })
task.wait(5)
ann7:Play()
msg:MakeSystemMessage("all", {Text = [[[Warning]: Reactor Explosion Uncertainty Emergency Preemption Protocol initiated, this facility will self destruct in 2 minutes.]], Color = Color3.new(1,0,0),})
task.wait(7)
local timer = 120
