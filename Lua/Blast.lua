...
local shockwave = sf:FindFirstChild('shockwave') or makeSound('rbxassetid://610327604', 5, false, 'shockwave');
...
local sdm1=sf:FindFirstChild('t6min') or makeSound("rbxassetid://1000895732",1.8,false,'t6min');
local sdm2=sf:FindFirstChild('selfdestruct') or makeSound("rbxassetid://1002834205",1.8,false,'selfdestruct');
