...
local ann1 = sf:FindFirstChild('evacatonce') or makeSound('rbxassetid://1474008656',2,false,'evacatonce');
local ann2 = sf:FindFirstChild('overheat') or makeSound('rbxassetid://159445410',2,false,'overheat');
local evac = sf:FindFirstChild('evac') or makeSound('rbxassetid://147296378',2,false,'evac');
local alarm = sf:FindFirstChild('alarm') or makeSound('rbxassetid://2451364019',2,true,'alarm');
local ann3 = sf:FindFirstChild('critical') or makeSound('rbxassetid://168877716',2,false,'critical');
local ann4 = sf:FindFirstChild('safeguards') or makeSound('rbxassetid://147296324',2,false,'safeguards');
local metalexplosion = sf:FindFirstChild('metalexplosion') or makeSound('rbxassetid://178962800', 0.5, false, 'metalexplosion');
local shockwave = sf:FindFirstChild('shockwave') or makeSound('rbxassetid://610327604', 0.5, false, 'shockwave');
...
local sdm2=sf:FindFirstChild('selfdestruct') or makeSound("rbxassetid://1000895732",2,false,'selfdestruct');
